...
public class StudentStreams {
	public static void main(String[] args) {
		...
		students.add(new Student(1,"Priya",10,80));
		students.add(new Student(2,"abcs",44,10));
		students.add(new Student(3,"rtn ",51,85));
		students.add(new Student(4,"ABCDE",15,60));
		students.add(new Student(5,"ttHIJ",5,70));
		students.add(new Student(6,"Kgu",89,65));
		students.add(new Student(7,"opk",55,60));
